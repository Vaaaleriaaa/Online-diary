...
import styles from "./StudentDaySchedule.module.css"
import StudentDayScheduleRow from "./StudentDayScheduleRow";

const StudentDaySchedule = ({
  dayName,
  date, 
  lessons,
  lessonSlots,
    ...
    <div className={styles.container}>
      ...
      <table className={styles.table}>
        <thead>
          ...
          <th className={styles["teacher_name"]}>Учитель</th>
...
export default StudentDaySchedule;